...
class GraphDenoiseConv(torch.nn.Module):
    def __init__(
        self,
        K,  #
        M,  # time steps
        ...
        self.edge_sym_mlp = NaiveMLP(c_in * 2, self.e_s_dim, edge_sym_head_dims, use_bn=use_bn)
        self.edge_dir_mlp = NaiveMLP(c_in * 2, self.e_d_dim, edge_dir_head_dims, use_bn=use_bn)
